...
**决策来源**: [`docs/roadmap/README.md` § 路线决策追加（2026-06-30）](../roadmap/README.md) 决策 #13–#16。
...
- [ ] schema 文档（这份）
- [ ] desktop 端 SQLite 表 + tauri-plugin-sql 接入
- [ ] desktop 端 star 按钮 + 备注编辑 sheet
- [ ] desktop 端 JSON export
- [ ] desktop 端 JSON import + 合并规则
- [ ] desktop 端 Anki CSV export
